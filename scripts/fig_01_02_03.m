...
for r = 1:4
    ...
    T        = readtable('data/Cflu_RSS_n_RNB.xlsx','sheet',cell2mat(rwanted(r)),'TreatAsMissing','NaN');
    ...
    set(gca,'Xtick',1970:10:2020,'Xgrid','on','Ygrid','on','Xlim',[1972 2025],'Ylim',ylim,'Ytick',ylim(1):ytick(r):ylim(2),'XMinorTick','on','XMinorGrid','on','box','on')
    if r == 3
        set(gca,'Ytick',0:ytick(r):ylim(2))      
    end
    
    
    if r == 4
        ylabel('CO_2 flux (PgC yr^{-1})','FontSize',14)
        title(cell2mat(txtTitle(r)),'fontweight','normal','FontSize',14)
        set(gca,'FontSize',14)
    else
        ylabel('CO_2 flux (PgC yr^{-1})','FontSize',12,'FontSize',12)
        title(cell2mat(txtTitle(r)),'fontweight','normal','FontSize',12.5)
        set(gca,'FontSize',12)
    end
...
set(gcf,'PaperPosition',[0 0 30 16.5])
print('fig04_RNB.eps','-depsc')
...
set(gca,'Xtick',-80:10:90,'Xgrid','on','Ygrid','on','Xlim',[-80 90],'Ylim',ylim,'XMinorTick','on','box','on')
ax = gca;
...
%     patch(x,y,[.6 .8 .9],'EdgeColor','none','FaceAlpha',.4)
    fill(x,y,[.6 .8 .9],'EdgeColor','none','FaceAlpha',.4)
    hold on
    ...
    set(gca,'Xtick',1970:10:2020,'Xgrid','on','Ygrid','on','Xlim',[1972 2025],'Ylim',ylim(r,:),'Ytick',ylim(r,1):ytick(r):ylim(r,2),'XMinorTick','on','XMinorGrid','on','box','on')
